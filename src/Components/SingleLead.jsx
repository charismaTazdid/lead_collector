            ...
            <Box sx={{ backgroundColor: followUp ? "wheat" : "white", width: 900, height: "auto", mb: 1, mt: 1, p: 3, borderRadius: 2 }} >
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", }}>
                    <Box sx={{ display: "flex", cursor: "pointer", backgroundColor: "#2F363F", p: 1, borderRadius: 1 }} onClick={() => setFollowUp(!followUp)}>
                        ...
                        <Typography fontSize={14} color={"white"} sx={{ textTransform: "capitalize" }}> {lead?.companyName} </Typography>
                    </Box>
                    <Box sx={{ display: "flex" }}>
                    ...
                    <Box sx={{ display: "flex", backgroundColor: "#2F363F", p: 1, borderRadius: 1 }}>
                        ...
                        <Typography fontSize={14} color={"white"} sx={{ textTransform: "capitalize" }}> {lead?.country} </Typography>
                    </Box>
                </Box>

                {/* Email  */}
                {
                    lead.primaryEmail || lead.secondaryEmail ?
                ...
                {/* Employee Info */}
                {
                    lead.employee || lead.employeeContact ?
                        <Box sx={{ mt: 1 }}>
